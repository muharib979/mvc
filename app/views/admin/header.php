...
.cat{border:1px solid #ddd;margin-bottom:5px;padding:5px;width:300px;cursor: pointer}

.adminleft{border-right:1px solid $ddd;float:left;margin-right:10px;padding-right:10px;width:200px;}

.widget{margin-bottom:20px;}
.widget h3{background: #3399ff none repeat scroll 0 0;border-bottom: 2px solid #066cd2;color:#000;margin:0 0 2px;padding:5px;box-shadow: 0 1px 1px #fff;}
...
.adminright h2{border-bottom: 2px dashed #666;color:#666;margin:0 0 10px;
padding-bottom: 10px;}
